...
%onsets = {};
open(ONSETS, "<$language-ValidOnsets.txt") or die("Couldn't open $language-ValidOnsets.txt\n");
...
%vowels = {};
open(VOWELS, "<$language-Vowels.txt") or die("Couldn't open $language-Vowels.txt\n");
my $vowels = <VOWELS>;
print "$vowels";
close(VOWELS);
#print "$vowels\n";
