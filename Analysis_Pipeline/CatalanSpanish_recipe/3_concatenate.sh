...
mkdir -p ${output}/${lang2_name}_${lang2_name}/100/
mkdir -p ${output}/${lang2_name}_${lang2_name}/1/
...
max2=`wc -l $(cat ${lang2_name}.txt) | grep "total" | awk '{print $1}' `
...
#send the first 100 lines of each file for each language to each of the 2 piles, for the 100 condition, and repeat 100 times for the switching every line condition
   #100 lines blocks
	...
	#mono2
         sed -n 1,100p $selfile1_lang2 >> ${output}/${lang2_name}_${lang2_name}/100/tags.txt
         sed -n 1,100p $selfile2_lang2 >> ${output}/${lang2_name}_${lang2_name}/100/tags.txt
	#bi
...
#echo in the single line switch $i
	...
	#mono2
        	 sed -n $i,${i}p $selfile1_lang2 >> ${output}/${lang2_name}_${lang2_name}/1/tags.txt
        	 sed -n $i,${i}p $selfile2_lang2 >> ${output}/${lang2_name}_${lang2_name}/1/tags.txt
	#bi
